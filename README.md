...
ANUDIP_ADV_EXCEL.pdf	Full written project report (objectives, methodology, findings, and recommendations)
Workbook structure
...
![img alt](https://github.com/adarpitadhar13-DA/Employee-Performance-and-Payroll-Management-Analytics/blob/a53dfcd96a82c7eb1b93336ba28a2134271bfa37/Second.png)

 Project Objective

To build a data-driven analytics framework that evaluates:

Compensation consistency across departments (HR, IT, Sales)
Experience-to-salary progression
Performance appraisal coverage gaps
Employee retention dynamics across corporate locations (Chicago, Los Angeles, New York)

 Problem Statement

Organizations often lack visibility into workforce cost and performance data, leading to:

Compensation disconnect — no clear link between experience, age, and pay
...
Flat wage-to-experience curve: minimal pay variance between junior and senior staff
...
Refer to ANUDIP_ADV_EXCEL.pdf for full methodology and analysis, or the .pptx for a quick visual summary

 License
This project was created for educational purposes as part of the Centre of Excellence for AI Advanced Excel training program.
